...
import org.monome.pages.pages.gui.MIDIKeyboard2GUI;
import org.w3c.dom.Element;
import org.w3c.dom.Node;
import org.w3c.dom.NodeList;

/**
 * A new MIDI keyboard page.  Usage information is available at:
 * 
 * no documentation yet
 *   
 * @author Tom Dinchak, Stephen McLeod, Umut Isik
 *
 */

public class MIDIKeyboard2Page implements Page, Serializable {
	...
	****************** alternative scales ***************/
	 ...
	 */
	public MIDIKeyboard2Page(MonomeConfiguration monome, int index) {
		this.monome = monome;
		this.gui = new MIDIKeyboard2GUI(this);
		this.index = index;	 
	...
	public void handlePress256(int x, int y, int value) {
		...
		if (y != (this.monome.sizeY - 1) && x < 14) {
			...
			int rowOffset = 5; //in number of notes in scale not semitones
			int note_num = this.getNoteNumber(x + rowOffset*(this.monome.sizeY-2-y)) + (this.octave[y] * 24);
