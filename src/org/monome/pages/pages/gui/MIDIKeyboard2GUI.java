...
import org.monome.pages.pages.MIDIKeyboard2Page;

public class MIDIKeyboard2GUI extends JPanel implements Serializable {
    static final long serialVersionUID = 42L;

	private MIDIKeyboard2Page page;
	 ...
	 */
	public MIDIKeyboard2GUI(MIDIKeyboard2Page page) {
		super();
		this.page = page;
		initialize();
	}
